...
public class UserDAO implements IUserDAO {
    ...
    private static final String INSERT_USERS_SQL = "INSERT INTO demo.users" + "  (name, email, " +
            "country) VALUES " +
            " (?, ?, ?);";

    private static final String SELECT_USER_BY_ID = "select id,name,email,country from demo.users" +
            " where id =?";
    ...
    private static final String UPDATE_USERS_SQL = "update demo.users set name = ?,email= ?, " +
            "country =? where id = ?;";
    private static final String SQL_INSERT = "INSERT INTO demo.employees (name, salary, " +
            "created_date) VALUES " +
            "(?,?,?)";
    private static final String SQL_UPDATE = "UPDATE demo.employees SET salary=? WHERE name=?";
    ...
    public void addUserTransaction(User user, int[] permission) {
        ...
        try {
            ...
            if (rowAffected == 1) {
                String sqlPivot = "INSERT INTO demo.User_Permission(user_id,permission_id) " +
                        "VALUES(?,?)";
